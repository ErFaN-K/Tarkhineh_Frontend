...
<template>
  <div class="flex flex-row w-full delay-100 border border-gray-400 rounded-lg md:flex-col hover:border-Primary">
        ...
        <div class="flex flex-col items-center w-full p-2 text-center md:px-2 md:py-4 gap-y-1">
            ...
            <p
                ...
                {{ branchAddress }}</p>
                <a :href="branchPageLink" class="text-xs font-Dana flex items-center justify-center w-32 h-8 border rounded-sm gap-x-1 max-md:hidden border-Primary text-Primary">
                <span>صفحه شعبه</span>
                <svg class="size-4">
