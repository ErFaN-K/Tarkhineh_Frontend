<template>
  <div
    class="is-hidden transition-all max-md:flex max-md:flex-col max-md:justify-center shadow-xl fixed inset-0 m-auto bg-white md:rounded-lg md:border md:border-gray-400 md:max-w-98 w-full max-md:h-svh h-max md:p-6 p-5 z-102"
  >
    <!-- Tarkhineh Logo -->
    ...
    <div v-if="false">
      ...
      <div class="flex items-center flex-col md:gap-y-1 gap-y-6 font-Dana mb-6">
        <span class="text-base text-gray-800 font-Dana-SemiBold"
          >ورود / ثبت ‌نام</span
        >
        <p class="md:text-xs text-sm text-gray-700 text-center">
      ...
      <div class="relative font-Dana">
        <input
          ...
          dir="ltr"
          type="text"
          class="w-full h-10 border border-gray-800 rounded-sm md:text-base md:px-4 font-Dana outline-none peer focus:border-Primary"
        />
        <!-- Label -->
        <label
          for="phoneNumber"
    ...
    <div v-else>
      ...
      <div class="flex items-center flex-col md:gap-y-1 gap-y-6 font-Dana mb-6">
        ...
        <p class="md:text-xs text-sm text-gray-700 text-center">
          کد تایید پنج‌رقمی به شماره *********** ارسال شد.
        </p>
      </div>
