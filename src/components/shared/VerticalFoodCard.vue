...
<template>
  ...
  >
    ...
    <div class="md:p-4 px-2 pb-2 pt-1">
      <!-- Food Title -->
      <h3
        class="md:font-Morabba-Bold md:text-xl font-Morabba-Medium text-xs text-center text-gray-800 line-clamp-1"
      >
        دلمه برگ کلم
      </h3>
      <!-- Food Information -->
      ...
      >
        ...
        <div class="flex flex-col items-start max-md:gap-y-2">
          ...
          <div class="flex items-center md:gap-x-1 gap-x-0.5 md:py-1">
            ...
            <!-- Rate Text -->
            <span
              class="relative top-0.5 text-custom text-gray-500 font-Dana max-md:hidden"
              >(۳۲ امتیاز)</span
            >
          </div>
        </div>
        ...
        <div class="flex flex-col items-end max-md:gap-y-1">
          ...
          <!-- Price -->
          <span class="md:text-base text-custom font-Dana text-gray-800"
            >۱۳۶٬۰۰۰ تومان</span
          >
        </div>
      </div>
