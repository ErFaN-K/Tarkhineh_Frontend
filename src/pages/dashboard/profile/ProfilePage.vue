...
<template>
    <div class="md:min-h-[calc(100vh-367px)] md:rounded-lg rounded-sm md:border md:border-gray-400 p-6">
      <!-- Title -->
      <div class="pb-2 border-b border-b-gray-400 max-md:hidden">
        <h4 class="text-gray-800 font-Dana-SemiBold text-xl"> {{ isDisabled ? 'پروفایل من' : 'ویرایش اطلاعات شخصی' }} </h4>
      </div>
      <!-- User Information -->
        ...
        <div class="flex items-center md:gap-x-4 max-md:gap-y-3 max-md:flex-col">
          ...
          <div class="w-full">
            <div class="relative font-Dana">
              ...
              <label
                for="firstName"
                :class="isDisabled ? '!text-gray-400' : text"
