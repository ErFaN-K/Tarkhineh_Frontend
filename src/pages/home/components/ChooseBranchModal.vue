...
<template>
    <div class="is-hidden transition-all fixed inset-0 m-auto px-5 flex items-center justify-center z-102 text-gray-800">
        <div class="md:max-w-202 max-w-80 w-full rounded-lg overflow-hidden bg-white shadow-xl"> 
            ...
            <!-- Card Main -->
            <div class="flex items-center flex-col gap-y-4 md:gap-y-5 md:px-6 md:pb-6 px-4 pb-4">
                <!-- Title -->
                <span class="text-xs font-Dana text-center md:text-base">برای دیدن منوی رستوران، لطفا شعبه مدنظر خود را انتخاب کنید:</span>
